...
NFL remains in standard mode. Non-NFL daily picks still require **82/110 and Failure Score 7/10** under the existing Recovery Mode+ rules. No candidate met those requirements with the evidence obtained. Fair probabilities, EV and hard price cutoffs have not been established; they have not been invented to create releases.

## First research alternatives

| Candidate | Reference number | Grade / units | What prevents release |
|---|---|---|---|
| Toronto ML at Texas, 8:05 p.m. ET | -137 | Pass / 0u | Independent fair-price estimate, batting-order verification and executable price |
| Boston ML at Tampa Bay, 7:10 p.m. ET | +113 | Pass / 0u | Independent fair-price estimate, batting-order verification and executable price |
| Texas Tech -7.5 vs Houston, 8 p.m. ET | -108 | Pass / 0u | Independent cover estimate and current availability/OL verification |
| Dylan Cease strikeouts | Threshold and price unverified | Pass / 0u | Actual market, Texas order and innings/strikeout distribution |
...
These are **incomplete verified-evidence subtotals**, not win probabilities or a calibrated model run. Unknown/stale inputs receive zero under the existing rules. No independent fair estimate was established before outside opinions were encountered; there is no backdated claim that one was. Missing fair price, execution and important availability inputs block release regardless of subtotal. Numeric Failure Scores remain unknown; the 7/10 release gate is not met.

| Candidate | Evidence subtotal / 110 | Shadow subtotal / 100 | Final grade | Units |
|---|---:|---:|---|---:|
| Toronto ML | 12 | 9 | Pass | 0 |
| Boston ML | 8 | 8 | Pass | 0 |
| Pittsburgh -1.5 | 8 | 8 | Pass | 0 |
| Cleveland -1.5 | 5 | 5 | Pass | 0 |
| Minnesota ML | 5 | 5 | Pass | 0 |
| Houston ML | 4 | 4 | Pass | 0 |
| Houston +7.5 | 4 | 4 | Pass | 0 |
| Texas Tech -7.5 | 4 | 4 | Pass | 0 |
| Miami–Wake Over 55.5 | 5 | 5 | Pass | 0 |
| Toronto +15.5 | 2 | 2 | Pass | 0 |
| New York +6.5 | 2 | 2 | Pass | 0 |
| Golden State -12.5 | 2 | 2 | Pass | 0 |
| Dylan Cease strikeouts — threshold unverified | 6 | 6 | Pass | 0 |

`candidates.json` records all 12 factor scores, evidence, failures and shadow inputs. Partial matchup, rest and ordinary market-quality evidence earns the listed points. Independent fair edge, value, Progressive Fade, Favorite Inflation, external agreement with Micks, Doc's confirmation and unsupported market signals receive zero. This prevents false precision from becoming an official grade. Scores are deliberately not presented as a meaningful ranking of team quality.
