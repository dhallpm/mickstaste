...
function generateMicksPicksOptions(req) {
  return {
    ...
    leagueCursor: param(req, 'leagueCursor'),
    startLeague: param(req, 'startLeague'),
    ...
    maxAllSportsRuntimeMs: param(req, 'maxAllSportsRuntimeMs') || param(req, 'allSportsRuntimeMs'),
