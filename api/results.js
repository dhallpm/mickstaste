...
function normalizeRecord(record = {}, config = {}) {
  ...
  return {
    ...
    notes: text(first(fields, ['Notes', 'Result Notes', 'Settlement Notes', 'Market Notes', 'Leg Results', 'Losing Leg'])),
    'A Grade Gate Result': text(first(fields, ['A Grade Gate Result'])),
    aGradeGateResult: text(first(fields, ['A Grade Gate Result'])),
    'A Grade Evidence Count': first(fields, ['A Grade Evidence Count']),
    aGradeEvidenceCount: first(fields, ['A Grade Evidence Count']),
    'Market Misprice Reason': text(first(fields, ['Market Misprice Reason'])),
    marketMispriceReason: text(first(fields, ['Market Misprice Reason'])),
    'Unresolved Conflict': text(first(fields, ['Unresolved Conflict'])),
    unresolvedConflict: text(first(fields, ['Unresolved Conflict'])),
    'A-Hunt Source Notes': text(first(fields, ['A-Hunt Source Notes'])),
    aHuntSourceNotes: text(first(fields, ['A-Hunt Source Notes'])),
    'Park/Weather Risk': text(first(fields, ['Park/Weather Risk'])),
    parkWeatherRisk: text(first(fields, ['Park/Weather Risk'])),
    'Blow-Up Risk': text(first(fields, ['Blow-Up Risk'])),
    blowUpRisk: text(first(fields, ['Blow-Up Risk'])),
    'Volatility Capped': text(first(fields, ['Volatility Capped'])),
    volatilityCapped: text(first(fields, ['Volatility Capped'])),
    Tags: text(first(fields, ['Tags'])),
    tags: text(first(fields, ['Tags'])),
