...
assert.doesNotMatch(html, /mickspicks-vip\.vercel\.app|href=["']#vip["']/)
...
assert.doesNotMatch(todayCardRender.vipHtml, /RAW FULL ANALYSIS MAIN/)
assert.doesNotMatch(todayCardRender.vipHtml, /TSI projects 170/)
